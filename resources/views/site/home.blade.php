...
@section('content')
    ...
    <div class="content-container-1">
        <div class="info-block">
            <h3>Расставляй приоритеты <br> правильно</h3>
            <span>- № 1 -</span>
            <p>Своевременное выполнение <br> важнейших задач</p>
        </div>
    ...
    <div class="content-container-3">
        ...
        <div class="info-block2">
            <h3>Никто не останется <br> без работы</h3>
            <span>- № 2 -</span>
            <p>Благодарая системе контроля занятости <br> сотрудников работа найдётся каждому</p>
        </div>
    </div>
    <div class="content-container-4">
        <div class="item-content4">
            <h3>Совместное использование <br> файлов</h3>
            <span>- № 3 -</span>
            <p>Просматривайте, редактируйте и <br> прикрепляйте файлы Ваших коллег<br></p>
        </div>
        <div class="item-content4">
         <h3>Встроенные <br> сервисы</h3>
            <span>- № 4 -</span>
            <p>Все нужные Вам сервисы<br> У вас под рукой</p>
           
        </div>
        <div class="item-content4">
          <h3>Быстрый <br> поиск</h3>
            <span>- № 5 -</span>
            <p>С помощью системы поиска Вы всегда <br> найдёте интересующую Вас информацию</p>
        </div>
    </div>
