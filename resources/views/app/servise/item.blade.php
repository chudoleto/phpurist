		...
		<div class="row">
			<div class="col-sm-12">
				<div class="form-group">
					...
					<input name="Kod" id="Kod" value="{{ old('Kod', null) ? old('Kod') : $item->Kod }}" type="text" class="form-control">
				</div>
			</div>
				<div class="col-sm-12">
				<div class="form-group">
			...
			<div class="col-sm-12">
				<div class="form-group">
					<label for="name">Версия</label>
					<input name="Version" id="Version" value="{{ old('Version', null) ? old('Version') : $item->Version }}" type="text" class="form-control">
				</div>
			</div>
				<div class="col-sm-12">
				<div class="form-group">
					<label for="name">Адрес</label>
					<input name="Address" id="Address" value="{{ old('Address', null) ? old('Address') : $item->Address }}" type="text" class="form-control">
				</div>
			</div>
		</div>
		<div class="row">
